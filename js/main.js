...
/* Função da Calculadora  - fim  */

/* Função para mudar de cor  - inicio  */
function mudarCor(cor) {
    document.querySelector('.cores').style.background = cor
}
/* Função para mudar de cor  - fim  */

/* Função para mudar de classe  - inicio  */
function mudarClasse() {
    document.querySelector('.texto-classe').className = 'classe2'
}
/* Função para mudar de cor  - fim  */

/* Função para mudar de idioma  - inicio  */
function mudarPt() {
    location.reload()
}
...
function mudarEn() {
    ...
    document.querySelector('.red-idioma').textContent = 'Pink'
...
/* Função para mudar de idioma  - fim  */